package com.github.kongchen.swagger.docgen.arcelik;
 ...
 */
public class ArcelikParameterExtension extends AbstractSwaggerExtension {
    ...
    private List<Parameter> extractParametersFromAnnotation(Type type, ClassToInstanceMap<Annotation> annotations) {
        ...
        if (annotations.containsKey(lambda.annotation.QueryParam.class)) {
            lambda.annotation.QueryParam param = annotations.getInstance(lambda.annotation.QueryParam.class);
            QueryParameter queryParameter = extractQueryParam(type, defaultValue, param);
            parameters.add(queryParameter);
        } else if (annotations.containsKey(lambda.annotation.PathParam.class)) {
            lambda.annotation.PathParam param = annotations.getInstance(lambda.annotation.PathParam.class);
            PathParameter pathParameter = extractPathParam(type, defaultValue, param);
            parameters.add(pathParameter);
        } else if (annotations.containsKey(lambda.annotation.HeaderParam.class)) {
            lambda.annotation.HeaderParam param = annotations.getInstance(lambda.annotation.HeaderParam.class);
        ...
        } */ else if (annotations.containsKey(lambda.annotation.FormParam.class)) {
            lambda.annotation.FormParam param = annotations.getInstance(lambda.annotation.FormParam.class);
    ...
    private QueryParameter extractQueryParam(Type type, String defaultValue, lambda.annotation.QueryParam param) {
    ...
    private PathParameter extractPathParam(Type type, String defaultValue, lambda.annotation.PathParam param) {
    ...
    private HeaderParameter extractHeaderParam(Type type, String defaultValue, lambda.annotation.HeaderParam param) {
    ...
    private FormParameter extractFormParameter(Type type, String defaultValue, lambda.annotation.FormParam param) {
